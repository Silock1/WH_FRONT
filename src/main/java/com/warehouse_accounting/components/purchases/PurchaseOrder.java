...
public class PurchaseOrder extends VerticalLayout {

    private PurchasesGridLayout purchasesGridLayout;
    private final TextField textFieldGridSelected = new TextField();
    private final Div parentLayer;

    public PurchaseOrder(Div parentLayer) {
        this.parentLayer = parentLayer;
        purchasesGridLayout = new PurchasesGridLayout(textFieldGridSelected);
        Div pageContent = new Div();
        pageContent.add(purchasesGridLayout);
    ...
    private HorizontalLayout getGroupButtons() {
        ...
        textProducts.setText("Заказы поставщикам");
    ...
    private HorizontalLayout getEditMenuBar() {
        ...
        editMenu.getSubMenu().addItem("Удалить", menuItemClickEvent -> {
            int selected = purchasesGridLayout.getProductGrid().asMultiSelect().getSelectedItems().size();
